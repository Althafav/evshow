...
const ArrowLongRight = ({ className = "" }: { className?: string }) => (
  <svg
    ...
    fill="none"
  >
    <circle cx="11.3695" cy="11.3695" r="11.3695" fill="url(#paint0_linear_26_3968)" />
    <path
...
export default function WhyExhibitCarousel({ pageData }: { pageData: any }) {
  const items = pageData?.whyexhibititems?.linkedItems ?? [];
